...
export const SHORT_QUESTIONS = [
    ...
    },
    {
        id: 59,
        category: "처리·실행",
        question: "파싱은 단순히 텍스트를 복사하여 다음 시스템으로 넘겨주는 작업일 뿐 데이터의 구조를 바꾸지는 않는다.",
        answer: false,
        explanation: "파싱은 단순한 복사가 아니라, 자연어를 시스템이 이해할 수 있는 구조화된 데이터(JSON 등)로 의미 있게 분해하고 해석하는 핵심 과정입니다.",
        type: "ox"
    },
    {
        id: 60,
        category: "처리·실행",
        question: "AI 설계에서 Few-shot이 '이런 패턴으로 해'라며 답변 생성을 유도하는 것이라면, 파싱은 '필수 형식에 맞게 나왔는지' 그 구조를 해석하고 검증하는 역할을 한다.",
        answer: true,
        explanation: "맞습니다. Few-shot은 모델이 패턴을 학습하게 유도하는 방법이고, 파싱은 출력된 결과물이 실제 시스템에서 쓸 수 있는 규격을 갖췄는지 분해하며 검증하는 장치입니다.",
        type: "ox"
    },
    {
        id: 26,
    ...
    },
    {
        id: 59,
        category: "처리·실행",
        question: "텍스트나 데이터를 읽어 시스템이 이해할 수 있도록 의도나 필드 등 구조화된 형태로 해석하고 분해하는 과정을 무엇이라고 할까요?",
        answer: "Parsing(파싱)",
